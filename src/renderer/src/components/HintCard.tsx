...
export default function HintCard(): React.JSX.Element {
  ...
  return (
    <div className="pointer-events-none absolute bottom-3 left-3 max-w-sm rounded-lg border border-zinc-200/60 bg-white/70 px-3 py-2 text-xs backdrop-blur dark:border-zinc-700/60 dark:bg-zinc-900/70">
